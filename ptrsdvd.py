...
def siapa():
	...
	if nama =="":
		print"\033[1;96m[!] \033[1;91mIsi yang benar cok"
		time.sleep(1)
		siapa()
	else:
		os.system('clear')
		jalan("\033[1;97mWelcome to termudahFB \033[1;92m" +nama+ "\n\033[1;97mTHX telah menggunakan tools ini !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	os.system('clear')
	print"\033[1;97mSilahkan login SC nya dulu bngst\n"
	username = raw_input("\033[1;96m[*] \033[1;97mUsername \033[1;91m: \033[1;92m")
	password = raw_input("\033[1;96m[*] \033[1;97mPassword \033[1;91m: \033[1;92m")
	if username =="anak" and password =="kontol":
		print"\033[1;96m[✓] \033[1;92mLogin success cok"
		time.sleep(1)
		login()
	else:
		print"\033[1;96m[!] \033[1;91mSalah njing!!"
		time.sleep(1)
                LoginSC()
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[☆] \x1b[1;93mLOGIN AKUN FACEBOOK ANDA TOL \x1b[1;96m[☆]' )
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\033[1;96m[✓] \x1b[1;92mLogin succes cok '
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mSepertinya akun buriq anda kena checkpoint")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email salah bgst")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def super():
	...
	print "\x1b[1;97m2.\x1b[1;93m Crack dari ID teman"
...
def pilih_super():
	peak = raw_input("\n\033[1;97m >>> \033[1;97m")
	if peak =="":
		print "\033[1;96m[!] \x1b[1;91mIsi yang benar tol"
		pilih_super()
	elif peak =="1":
		os.system('clear')
		print logo
		...
		print logo
		print 42*"\033[1;96m="
		idt = raw_input("\033[1;96m[+] \033[1;93mMasukan ID teman njing \033[1;91m: \033[1;97m")
		try:
